...
extension Data {
  ...
  public init?(quotedPrintableEncoded qpData:Data,
               options:QuotedPrintableDecodingOptions = .default)
  {
    ...
    while true {
      ...
      if byte != equalitySign {
        ...
        if ii == qpData.count - 2 {
          ...
          case (CR, _):
            ii += 1
          case (let digit1, let digit2)
            where digit1._isValidHexadecimalDigit && digit2._isValidHexadecimalDigit:
  ...
  public init?(quotedPrintableEncoded qpString:String,
               options:QuotedPrintableDecodingOptions = .default)
  {
...
extension Data {
  ...
  public func quotedPrintableEncodedData(options:QuotedPrintableEncodingOptions = .default) -> Data {
    ...
    while true {
      ...
      if (requireEncoding && numberOfCharactersInLine > 73) ||
        (!requireEncoding && !insertRawCRLF && numberOfCharactersInLine == 75)
      {
